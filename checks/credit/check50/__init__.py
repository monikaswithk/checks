...
class Credit(Checks):
    ...
    def test8(self):
        ...
        self.spawn("python credit.py").stdin("5105105105135100").stdout("^INVALID\n", "INVALID\n").exit(0)

    @check("exists")
    def test9(self):
        """identifies 4111111111111114 as INVALID"""
        self.spawn("python credit.py").stdin("4111111111111114").stdout("^INVALID\n", "INVALID\n").exit(0)

    @check("exists")
    def test10(self):
        """identifies 378282246310006 as INVALID"""
        self.spawn("python credit.py").stdin("378282246310006").stdout("^INVALID\n", "INVALID\n").exit(0)
